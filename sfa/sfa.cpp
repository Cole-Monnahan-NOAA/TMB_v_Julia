// Taken from https://github.com/James-Thorson/2018_FSH556/blob/master/Week%208%20--%20Multivariate%20models/Lecture%208/spatial_factor_analysis_v1.cpp
// and modified slightly

// Spatial factor analysis example
...
Type objective_function<Type>::operator() ()
{
  ...
  // Likelihood of the random effects via GMRF. Uses specialized
  // functions in the density library which returns
  // -log-likelihood after scaling by a variance then evaluating
  // at Omega vector
  for(int f=0; f<n_f; f++){
